  ...
  return (
    <SafeAreaView>
      <View style={styles.XBox}>
        ...
        <Avatar onPress={() => navigation.navigate('profile' as never)} circular size="$4">
          <Avatar.Image
      ...
      <View style={StyleSheet.flatten([styles.YBox, { padding: 28 }, { paddingTop: 10 }])}>
        <H6 style={{ paddingLeft: 4 }}>Country</H6>
        <DropDownPicker
          style={{ marginTop: 4 }}
          open={countryOpen}
